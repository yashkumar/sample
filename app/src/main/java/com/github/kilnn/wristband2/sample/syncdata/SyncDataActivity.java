        ...
        mSyncDisposable = mWristbandManager
                ...
                .flatMapCompletable(new Function<SyncDataRaw, CompletableSource>() {
                    ...
                    public CompletableSource apply(SyncDataRaw syncDataRaw) throws Exception {
                        System.out.println("value of daya is here "+syncDataRaw.getDataType());
                        ...
                        if (syncDataRaw.getDataType() == SyncDataParser.TYPE_HEART_RATE) {
                          ...
                          {
                              System.out.println("value is her "+datas.get(i).getDistance());
                              System.out.println("value is her "+datas.get(i).getStep());
                              System.out.println("value is her "+datas.get(i).getCalories());
                          }
